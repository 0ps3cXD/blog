        ...
        <footer className="bg-primary text-secondary p-8 text-center w-screen flex flex-col gap-4 justify-center items-center" style={{ fontFamily: poppins.style.fontFamily}}>
            <div className="w-full flex flex-col md:flex-row justify-evenly items-center md:items-start text-center md:text-start gap-4 p-4">
                <div className="flex flex-col gap-2 justify-center items-start w-[200px] md:w-[300px]">
                    ...
                    <Link href={"/"} className="text-primary-accent">Home</Link>
                    <Link href={"/books"} className="text-primary-accent">Bücher</Link>
                    <Link href={"/coachings"} className="text-primary-accent">Coachings</Link>
                    <Link href={"/contact"} className="text-primary-accent">Kontakt</Link>

                </div>
                <div className="flex flex-col gap-2 justify-center items-start w-[200px] md:w-[300px]">
                    <h4 className="font-semibold text-lg">Rechtliches</h4>
                    <Link href={"/impressum"} className="text-primary-accent">Impressum</Link>
                    <Link href={"/datenschutz"} className="text-primary-accent">Datenschutz</Link>
                    <Link href={"/cookies"} className="text-primary-accent">Cookie-Einstellungen</Link>
                </div>
                <div className="flex flex-col gap-2 justify-center items-start w-[200px] md:w-[300px]">
            ...
            <div className="flex flex-row justify-evenly items-center gap-5">
                <Link href={"https://www.instagram.com/behappycoaching/"}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="text-secondary">
